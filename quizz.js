/* create a quiz*/
/*quiz js object which contains for 25 questions the id the question text, the options to choose
which are a,b,c or d, then the provided answer, score and the status*/
var quiz = {
    "JS": [
        {
            "id": 1,
